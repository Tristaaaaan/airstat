...
//     final availablePortsList = ref.watch(serialListProvider);
//     final serialCommunication = ref.read(serialCommunicationProvider);

//     useEffect(() {
//       final subscription = serialCommunication.startSerial().listen((result) {
...
//     useEffect(() {
//       Future<void> fetchSerialList() async {
//         final serialList = await serialCommunication.getAvailablePorts();
//         ref.read(serialListProvider.notifier).state = serialList ?? [];
//       }
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text("Check Available Serial Ports"),
//         centerTitle: true,
//       ),
//       body: Center(
//         child: Column(
...
//               itemCount: availablePortsList.length,
//               itemBuilder: (context, index) => Text(availablePortsList[index]),
//             ),
//           ],
//         ),
//       ),
